...
const mainFeatures = [
  {
    ...
    desc: "Generate storyboards, write viral captions, and get market insights with AI",
    color: "violet",
  ...
  },
  {
    ...
    desc: "Two-way marketplace where creators find deals and brands discover talent",
    color: "pink",
  ...
  },
  {
    ...
    subtitle: "Gear Up",
    desc: "Rent professional equipment like booking a hotel - search, pick dates, and go",
    color: "orange",
        ...
        <div className="max-w-6xl mx-auto text-center">
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white shadow-lg border border-violet-100 mb-8">
              ...
              <span className="text-sm font-bold text-violet-900">The All-in-One Creator OS</span>
              <span className="px-2.5 py-0.5 rounded-full bg-gradient-to-r from-violet-500 to-pink-500 text-white text-xs font-bold">NEW</span>
            </motion.div>
            ...
            <motion.p variants={itemVariants} className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              AI-powered tools, brand partnerships, and equipment rental — 
              <span className="font-semibold text-violet-600"> all in one energetic platform </span>
              built for creators who want to level up.
            </motion.p>
      ...
      <section className="py-20 px-4 bg-white/50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Four simple steps to unlock your creator potential</p>
          </motion.div>

          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Create Account", desc: "Sign up as Creator, Brand, or Renter", color: "violet", icon: Users },
              { step: "02", title: "Choose Your Path", desc: "Use AI tools, find deals, or rent gear", color: "pink", icon: ArrowRight },
              { step: "03", title: "Connect & Create", desc: "Collaborate, create content, book equipment", color: "orange", icon: Handshake },
              { step: "04", title: "Grow & Earn", desc: "Track analytics, get paid, level up", color: "green", icon: TrendingUp },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { value: "10,000+", label: "Active Creators", icon: Users, color: "violet" },
              { value: "$2.5M+", label: "Paid to Creators", icon: DollarSign, color: "pink" },
              { value: "500+", label: "Brand Partners", icon: Star, color: "orange" },
              { value: "98%", label: "Satisfaction Rate", icon: Heart, color: "red" },
            ].map((stat, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Try Our Demo Accounts</h2>
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Experience LumiAI from different perspectives. Use these accounts to explore all features:
              </p>
              <div className="grid md:grid-cols-4 gap-4">
                {[
                  { role: "Creator", email: "sarah@demo.com", color: "violet" },
                  { role: "Company", email: "glow@demo.com", color: "pink" },
                  { role: "Gear Owner", email: "alex@demo.com", color: "orange" },
                  { role: "Renter", email: "jordan@demo.com", color: "blue" },
                ].map((account, i) => (
          ...
          <div className="relative bg-gradient-to-r from-violet-600 via-pink-500 to-orange-500 rounded-3xl p-12 text-center text-white overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Join thousands of creators, brands, and renters building the future of content creation.
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><Link href="/auth" className="hover:text-orange-600 transition-colors">Gear Owner Login</Link></li>
                <li><Link href="/auth" className="hover:text-blue-600 transition-colors">Renter Login</Link></li>
              </ul>
            </div>
            <div>
