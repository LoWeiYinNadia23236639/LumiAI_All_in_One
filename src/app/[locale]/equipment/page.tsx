...
function EquipmentPage() {
  ...
  const [userGear, setUserGear] = useState<typeof equipment[number][]>([]);
  ...
  const allEquipment = [...equipment, ...userGear];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-amber-100 text-orange-700 text-sm font-semibold mb-4">
            ...
            {t("rentProfessionalGear")}
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-4">
            {t("bookLikeHotel")} <span className="gradient-text">Hotel</span>
          </h1>
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            {t("searchSubtitle")}
          </p>
          {user?.role === "influencer" && (
            <Link href="/analytics/dashboard?tab=gear">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            { value: "2,500+", label: t("gearItems"), icon: Camera },
            { value: "150+", label: t("verifiedOwners"), icon: CheckCircle },
            { value: "$2M+", label: t("insuranceCoverage"), icon: Shield },
            { value: "4.8/5", label: t("userRating"), icon: Star },
          ].map((stat, i) => (
        ...
        <div className="bg-white rounded-2xl shadow-lg border p-6 mb-8">
          <div className="grid md:grid-cols-4 gap-4">
            <div className="md:col-span-1">
              <label className="text-sm font-medium text-neutral-700 mb-2 block">{t("whatGear")}</label>
            ...
            <div>
              <label className="text-sm font-medium text-neutral-700 mb-2 block">{t("pickup")}</label>
              <div className="relative">
            ...
            <div>
              <label className="text-sm font-medium text-neutral-700 mb-2 block">{t("return")}</label>
              <div className="relative">
                <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-400" />
                <input 
                  type="date"
          ...
          {filteredEquipment.map((item, index) => (
            ...
            >
              ...
              <div className="h-48 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center relative">
                ...
                {userGear.some((g) => g.id === item.id) && (
                  <div className="absolute bottom-4 left-4 bg-violet-500 text-white text-xs font-bold px-2 py-1 rounded-full">
                    {t("listedByYou")}
                  </div>
                )}
              </div>
              ...
              <div className="p-5">
                ...
                {/* What's Included */}
                <div className="mb-4">
                  <p className="text-xs text-neutral-500 mb-2">{t("includes")}:</p>
                ...
                <div className="mb-4">
                  <p className="text-xs text-neutral-500 mb-2">{t("availableDates")}:</p>
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">{t("perDay")}</p>
                  </div>
